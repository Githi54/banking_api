...
TransactionsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [transactions_service_1.TransactionsService, bank_service_1.BankService],
        imports: [typeorm_1.TypeOrmModule.forFeature([transaction_entity_1.Transactions, bank_entity_1.Bank])],
    })
], TransactionsModule);
